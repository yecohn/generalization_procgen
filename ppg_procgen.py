...
def parse_args():
    ...
    parser.add_argument("--total-timesteps", type=int, default=1e9,
                    ...
                    if "episode" in item.keys():
                        ...
                        if args.checkpoint:
                            if item["episode"]["r"] > best_episodic_return:
                                ...
                                torch.save(agent.state_dict(), f"models/best.pt")
                                print(f"new record reach, saving the model")
                                print(f"best episodic return:{best_episodic_return}")
                        break
